...
import IMG1 from '@assets/children-1822688_1280.jpg'
import './CustomCurousal.css'
function CustomCurousal() {
  return (
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      ...
      <div className="carousel-caption d-none d-md-block">
        ...
        <p>SDiscover joy in every jump, laughter in every swing. </p>
      </div>
    </div>
